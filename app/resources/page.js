    ...
    <div className="pop-up-div">
      <div className="pop-up-div-1">
        <img
          ...
          loading="lazy"
          width={32}
          data-w-id="aa170ce5-f402-3a6c-46e3-e1d8dc15bacd"
          alt=""
            ...
            <div className="div-block-25">
              <div className="div-block-24">
                ...
                <img
                  ...
                  loading="lazy"
                  alt=""
                  className="image-64 w-dyn-bind-empty"
                />
              </div>
              <div>
                <h1 className="heading-31 w-dyn-bind-empty" />
                <a
                  href="#"
                  className="new-button-copy spark-icon-left-button next w-inline-block"
                >
                  <div className="spark-small-res w-embed">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 256 256"
                    >
