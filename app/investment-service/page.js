...
export default function InvestmentServices() {
  ...
  <meta charSet="utf-8" />
  <title>Investment Service</title>
  <meta content="Investment Service" property="og:title" />
  <meta content="Investment Service" property="twitter:title" />
    ...
    <div className="pop-up-div">
      <div className="pop-up-div-1">
        <img
          ...
          loading="lazy"
          width={32}
          data-w-id="fee1dc4e-73a5-49c9-1978-aa314469cdc4"
          alt=""
  ...
  <section className="section-11">
    <div className="w-layout-blockcontainer container-14 w-container">
      <img
        ...
        className="image-43"
      />
      <a href="#" className="lightbox-link-3 w-inline-block w-lightbox">
        <img
      ...
      >
        ...
        >
          <div className="div-block-21">
            ...
            <a href="/innovative-investment" className="w-inline-block">
              <img
        ...
        >
          <div className="div-block-22">
            ...
            <a href="/crowdfunding" className="w-inline-block">
              <img
                src="/images/Frame-2.svg"
                loading="lazy"
        ...
        >
          <div className="div-block-23">
            ...
            <a href="/assets-tokenization" className="w-inline-block">
              <img
                src="/images/Frame-2.svg"
                loading="lazy"
