...
export default function Crowdfunding() {
  ...
  <meta content="Crowdfunding" property="twitter:title" />
    ...
    <div className="pop-up-div">
      <div className="pop-up-div-1">
        <img
          ...
          loading="lazy"
          width={32}
          data-w-id="a3ac7540-d1c8-d4e2-6b2a-658935998143"
          alt=""
    ...
    <div className="w-layout-blockcontainer container-27 w-container">
        <div className="brix---accordion-v3-card-3">
          ...
          <div className="w-layout-grid brix---grid-1-column-gap-row-3">
            <div
              className="brix---accordion-item-wrapper-v3-first-3"
            >
                ...
                <div className="brix---accordion-header-2">
                  <div className="brix---color-neutral-802">
                    <h3 className="brix---accordion-title-3">
                      Why choose UFUND for crowdfunding?
                    </h3>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="brix---color-neutral-801">
                    <p className="brix---paragraph-default-5">
                      UFUND is a decentralized network where businesses and
                      investors can benefit from crowdfunding and tokenization.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              className="brix---accordion-item-wrapper-v3-3"
            >
              <div className="brix---accordion-right-side-2">
                <a
                  href="#"
              ...
              <div className="brix---accordion-content-wrapper-v2-2">
                <div className="brix---accordion-header-2">
                  <div className="brix---color-neutral-802">
                    <h3 className="brix---accordion-title-3">
                      How does everything work on UFUND?
                    </h3>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="brix---color-neutral-801">
                    <p className="brix---paragraph-default-5">
                      UFUND is an innovative platform for crowdfunding, helping
                      small and medium businesses (SMBs) to connect with
                      investors. It requires you to enroll, so you can start
                      investing to earn or campaigning to fundraising.
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="brix---color-neutral-801">
                    <p className="brix---paragraph-default-5">
                      ...
                      host tokens . We secure all users's Fiat funds into
            ...
            >
              ...
              <div className="brix---accordion-content-wrapper-v2-2">
                <div className="brix---accordion-header-2">
                  <div className="brix---color-neutral-802">
                    <h3 className="brix---accordion-title-3">
                      Do you have an Android Mobile App?
                    </h3>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="brix---color-neutral-801">
                    <p className="brix---paragraph-default-5">
                      Yes! In addition to our website, UFUND is also available
            ...
            >
              ...
              <div className="brix---accordion-content-wrapper-v2-2">
                <div className="brix---accordion-header-2">
                  <div className="brix---color-neutral-802">
                    <h3 className="brix---accordion-title-3">
                      How can I get more information about UFUND?
                    </h3>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="brix---color-neutral-801">
                    <p className="brix---paragraph-default-5">
                      If you need more information or any help, you can contact
                      us directly at support@ufund.online.
                    </p>
                  </div>
                </div>
              </div>
