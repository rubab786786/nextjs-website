...
export default function NewsMedia() {
  ...
  <meta content="News & Media" property="og:title" />
  <meta content="News & Media" property="twitter:title" />
    ...
    <div className="pop-up-div">
      <div className="pop-up-div-1">
        <img
          ...
          loading="lazy"
          width={32}
          data-w-id="3bc1e616-41ce-1152-c7ee-282cf701c033"
          alt=""
  ...
  <section className="section-news1">
    <div className="w-layout-blockcontainer container-news1 w-container">
      <img
    ...
    <div className="w-layout-blockcontainer container-news2 w-container">
      <div className="div-block-37">
        ...
        >
          <div
            id="w-node-_291f991a-2bea-0cc0-a85e-c79ad50fede1-fd8ec5ec"
            className="w-layout-cell cell-58"
          >
            <img
          ...
          <div
            id="w-node-_291f991a-2bea-0cc0-a85e-c79ad50fede2-fd8ec5ec"
            className="w-layout-cell"
          >
            <div className="uui-heroheader23_item">
              ...
              <div className="uui-heroheader23_item-text-wrapper">
                <div className="uui-text-size-large-5">25 Feb 2024</div>
              </div>
            </div>
      ...
      <div className="div-block-38">
        ...
        >
          <div
            id="w-node-fecfe02e-13cd-d3be-5e6e-64f19a48651a-fd8ec5ec"
            className="w-layout-cell cell-59"
          >
            <div className="uui-heroheader23_item">
              <div className="uui-heroheader23_item-icon-wrapper">
                <img src="/images/Vector-1.svg" loading="lazy" alt="" />
            ...
            <h1 className="heading-46">
              UFUND in its whitepaper made the difference between Security Token
              and Utility Token
            </h1>
            <p className="paragraph-32">
              Credibly fashion user friendly platforms via end-to-end sources.
          ...
          <div
            ...
            className="w-layout-cell cell-60"
          >
            <img
      ...
      <div className="div-block-39">
        <div
          id="w-node-_3cd9bd9f-6b8a-305e-b0f0-116148d75643-fd8ec5ec"
          className="w-layout-layout quick-stack-39 wf-layout-layout"
        >
          <div
            id="w-node-_3cd9bd9f-6b8a-305e-b0f0-116148d75644-fd8ec5ec"
            className="w-layout-cell cell-58"
          >
            <img
          ...
          <div
            id="w-node-_3cd9bd9f-6b8a-305e-b0f0-116148d75646-fd8ec5ec"
            className="w-layout-cell"
          >
            <div className="uui-heroheader23_item">
              <div className="uui-heroheader23_item-icon-wrapper">
            ...
            <h1 className="heading-46">
              UFUND Security Token Sales Is LIVE - Get 10 % Special Discount!
            </h1>
            <p className="paragraph-32">
              Credibly fashion user friendly platforms via end-to-end sources.
              Continually underwhelm sustainable sources after long-term
