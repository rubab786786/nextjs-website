    ...
    <div className="w-layout-blockcontainer container-terms-1 w-container">
      ...
      >
        ...
        >
          ...
          <Link href="#user-registration" className="link-block-13 w-inline-block">
          ...
          <Link href="#refunds-policy" className="link-block-13 w-inline-block">
          ...
          <Link href="#submissions" className="link-block-13 w-inline-block">
            <h1 className="heading-44">13. Submissions</h1>
          </Link>
          <Link href="#site-management" className="link-block-13 w-inline-block">
            <h1 className="heading-44">14. Site management</h1>
          </Link>
          <Link href="#privacy-policy" className="link-block-13 w-inline-block">
        ...
        >
          ...
          <Link href="#governing-law" className="link-block-13 w-inline-block">
          ...
          <Link href="#corrections" className="link-block-13 w-inline-block">
            <h1 className="heading-44">21. Corrections</h1>
          </Link>
          <Link href="#disclaimer" className="link-block-13 w-inline-block">
          ...
          <Link href="#indemnification" className="link-block-13 w-inline-block">
            <h1 className="heading-44">24. Indemnification</h1>
          </Link>
          <Link href="#user-data" className="link-block-13 w-inline-block">
          ...
          <Link href="#miscellaneous" className="link-block-13 w-inline-block">
            <h1 className="heading-44">28. Miscellaneous</h1>
          </Link>
          <Link href="#contact-us" className="link-block-13 w-inline-block">
