            ...
            <div>
              ...
              <ul role="list" className="footer-list-wrapper">
                <li className="brix---footer-list-item">
                  <Link href="/site-map" className="brix---footer-link">
                    Site map
                  </Link>
                </li>
                <li className="brix---footer-list-item">
                  <Link href="/privacy-policy" className="brix---footer-link">
                    Privacy Policy
                  </Link>
                </li>
                <li className="brix---footer-list-item" />
                ...
                <li className="brix---footer-list-item">
                  <Link href="/disclaimer" className="brix---footer-link">
                    Disclaimer
                  </Link>
                </li>
                <li className="brix---footer-list-item">
                  <Link href="/news-media" className="brix---footer-link">
                    News &amp; media
                  </Link>
                </li>
              </ul>
                  ...
                  <div className="w-layout-grid contact-links-grid-1">
                    ...
                    >
                      ...
                      <div className="w-layout-cell cell-18">
                        ...
                        <Link href="#" className="link-block-5 w-inline-block">
